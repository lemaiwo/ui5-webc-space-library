sap.ui.define(['require', "sap/ui/webc/common/thirdparty/base/asset-registries/Themes"], function (require, _Themes) {
  ...
  ["sap_fiori_3", "sap_horizon", "sap_horizon_dark", "sap_horizon_hcb", "sap_horizon_hcw"].forEach(themeName => (0, _Themes.registerThemePropertiesLoader)("space-package", themeName, loadAndCheck));
});